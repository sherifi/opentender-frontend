	...
	indicators: {
		ADMINISTRATIVE: {
			...
			subindicators: {
				...
				// ADMINISTRATIVE_DISCREPANCIES_BETWEEN_CALL_FOR_TENDER_AND_AWARD: {name: 'Discrepancies between call for tender and contract award notices', desc: 'Discrepancies between call for tender and contract award notices is the ratio of fields with different values in the call for tender and contract award announcements related to a given tender (based on last published versions).'},
		...
		CORRUPTION: {
			...
			subindicators: {
				...
				// CORRUPTION_ELIGIBILITY_CRITERIA_LENGTH: {name: 'Eligibility criteria length', desc: 'Eligibility criteria length signals the risk of criteria being tailored to one company with the criteria description being excessively long.'},
		...
		TRANSPARENCY: {
			...
			subindicators: {
				...
				TRANSPARENCY_NUMBER_OF_KEY_MISSING_FIELDS: {name: 'Number of key missing fields in form', desc: 'Number of key missing fields is the ratio of fields with missing values in the call for tender and contract award announcement related to a given tender (based on the most recently published versions).'}
			},
			icon: 'icon-checkmark'
		}
	},
