...
@Component({
	...
	template: `
		<div class="graph-header">
			<div class="graph-title">Sector Overview by {{this.graph !== this.cpvs_code_main ? 'Volume (€)' : 'Tender Count'}}</div>
			<div class="graph-toolbar">
				...
				<button class="tool-button" [ngClass]="{down:this.graph==this.cpvs_code_main}" (click)="this.graph=this.cpvs_code_main">Absolute</button>
			</div>
		</div>
		<ngx-charts-tree-map
