...
import {PositioningService, PositioningOptions} from './positioning.service';
...
export class ComponentLoaderFactory {
	...
	public constructor(componentFactoryResolver: ComponentFactoryResolver, ngZone: NgZone, injector: Injector, posService: PositioningService) {
		this._ngZone = ngZone;
