...
import {ComponentLoader, ComponentLoaderFactory} from './component-loader.factory';
...
export class TypeaheadDirective implements OnInit, OnDestroy {
	...
	@Output() public typeaheadOnSelect: EventEmitter<TypeaheadMatch> = new EventEmitter<TypeaheadMatch>();
	/** fired when blur event occurres. returns the active item */
	@Output() public typeaheadOnBlur: EventEmitter<any> = new EventEmitter();
	/** fired when focus event occurres */
	@Output() public typeaheadOnFocus: EventEmitter<any> = new EventEmitter();
	...
	public onChange(e: any): void {
		...
		if (e.keyCode === 13) {
			this.typeaheadOnSelect.emit(new TypeaheadMatch(null, value));
		...
		if (value.trim().length == 0) {
			this.typeaheadOnSelect.emit(new TypeaheadMatch(null, ''));
		}
	...
	public onFocus(): void {
		...
		this.typeaheadOnFocus.emit(true);
	}
	...
	public onBlur(): void {
		...
		this.typeaheadOnFocus.emit(false);
	}
	...
	public constructor(control: NgControl, viewContainerRef: ViewContainerRef, element: ElementRef, renderer: Renderer2, cis: ComponentLoaderFactory) {
		...
		this._typeahead = cis.createLoader<TypeaheadContainerComponent>(element, viewContainerRef, renderer);
	}
